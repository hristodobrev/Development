            ...
            <form class="form-horizontal" method="post">
                <fieldset>
                    ...
                    <div class="form-group">
                        <label for="name" class="col-lg-3 control-label">Director's Name</label>
                        <div class="col-lg-9">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            ...
                            <span class="help-block">Add some notes about the director.</span>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-lg-9 col-lg-offset-3">
                            <button type="reset" class="btn btn-default">Clear</button>
                            <button type="submit" name="add-director" class="btn btn-primary">Add Director</button>
                        </div>
                    </div>
                </fieldset>
            </form>
