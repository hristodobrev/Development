            ...
            <form class="form-horizontal" method="post">
                <fieldset>
                    ...
                    <div class="form-group">
                        <label for="name" class="col-lg-3 control-label">Genre's Name</label>
                        <div class="col-lg-9">
                            <input type="text" name="name" class="form-control" id="name"
                                   placeholder="Enter Genre's name" required>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            ...
                            <span class="help-block">Add some notes about the genre.</span>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-lg-9 col-lg-offset-3">
                            <button type="reset" class="btn btn-default">Clear</button>
                            <button type="submit" name="add-genre" class="btn btn-primary">Add Genre</button>
                        </div>
                    </div>
                </fieldset>
            </form>
